...
**Status:** Accepted — core PBAC policy implemented in PR #29; per-purpose narrowing of profile items, `EpisodicGist.deniedPurposes`, and per-item deny-decision audit logging completed in issue #36
